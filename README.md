...
El paquete está disponible en npm, puedes instalarlo fácilmente con:
...
Alternativamente, si deseas usar la última versión de desarrollo, puedes instalarlo directamente desde GitHub:
